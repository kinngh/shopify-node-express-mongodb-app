...
/**
 * Defines the possible values for the 'autocomplete' property specific to URL fields.
 */
type URLAutocompleteField =
  | "email"
  | "language"
  | "organization"
  | "additional-name"
 ...
 * and 's-url-field' custom elements and their associated attributes.
 */
declare module "react" {
  ...
  /**
   * Declares the 's-text-field' and 's-url-field' custom intrinsic elements for JSX.
  ...
  namespace JSX {
    interface IntrinsicElements {
      ...
      /**
       * The 's-url-field' custom element.
       * It extends standard HTML attributes and adds its specific properties.
       *
       * Collect URLs from users with built-in formatting and validation.
       */
      "s-url-field": React.DetailedHTMLProps<
        React.InputHTMLAttributes<HTMLInputElement>,
        HTMLElement
      > & {
        /**
        ...
        // Event Handlers for the s-url-field component.
        // These are mapped to standard React event handler prop names.
        // The `currentTarget` will be the <s-url-field> element.
