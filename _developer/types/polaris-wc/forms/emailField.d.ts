...
/**
 * Defines the possible values for the 'autocomplete' property specific to email fields.
 */
type EmailAutocompleteField =
  | "url"
  | "language"
  | "organization"
  | "additional-name"
...
/**
 * Augments the 'react' module to include type definitions for the 's-email-field'
...
declare module "react" {
  ...
  /**
   * Declares the 's-email-field' custom intrinsic element for JSX.
   * This allows you to use <s-email-field> directly in your JSX code with type safety.
   */
  namespace JSX {
    interface IntrinsicElements {
      /**
       * The 's-email-field' custom element.
       ...
       */
      "s-email-field": React.DetailedHTMLProps<
      ...
      > & {
        ...
        // Event Handlers for the s-email-field component.
        // These are mapped to standard React event handler prop names.
        // The `currentTarget` will be the <s-email-field> element.
