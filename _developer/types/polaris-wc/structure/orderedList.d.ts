...
/**
 * Augments the 'react' module to include type definitions for the 's-ordered-list'
...
declare module "react" {
  ...
  /**
   * Declares the 's-ordered-list' and 's-list-item' custom intrinsic elements for JSX.
   * This allows you to use them directly in your JSX code with type safety.
   */
  namespace JSX {
    interface IntrinsicElements {
      /**
       * The 's-ordered-list' custom element.
       * It extends standard HTML attributes.
       *
       * Displays a numbered list of related items in a specific sequence.
       */
      "s-ordered-list": React.DetailedHTMLProps<
        React.HTMLAttributes<HTMLElement>,
        HTMLElement
      > & {
        // No specific properties listed for s-ordered-list itself in the provided documentation
      };
