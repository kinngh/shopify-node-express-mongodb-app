...
/**
 * Defines the possible keyword values for badge sizes.
 */
type BadgeSize = "base" | "large" | "large-100";
 ...
 * (Copied from the Button/Icon definitions, assuming it's the same set).
 */
type IconType =
  | ""
  | "replace"
...
/**
 * Augments the 'react' module to include type definitions for the 's-badge'
...
declare module "react" {
  ...
  /**
   * Declares the 's-badge' custom intrinsic element for JSX.
   * This allows you to use <s-badge> directly in your JSX code with type safety.
   */
  namespace JSX {
    interface IntrinsicElements {
      /**
       * The 's-badge' custom element.
      ...
      > & {
        ...
        /**
         * Specifies the type of icon that will be displayed within the badge.
         */
        icon?: IconType;
